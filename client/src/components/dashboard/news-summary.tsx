      ...
      <div className="px-1">
        {sortedNews.map((item, index) => {
          ...
          const swipeHandlers = useSwipeable({
            onSwipedLeft: () => markAsRead(item.id),
            onSwipedRight: () => toggleAIAnalysis(item.id),
            trackMouse: true
          });
          ...
          return (
            <div 
              key={index} 
              className="mx-3 py-4 border-t border-neutral-200 dark:border-neutral-800 relative overflow-hidden"
            >
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    ...
                    <Button 
                      variant="outline" 
                      size="sm" 
                      onClick={() => toggleAIAnalysis(item.id)}
